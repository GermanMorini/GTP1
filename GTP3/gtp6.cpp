...
int main() {
        ...
        for (int i = 0; i < 10; i++) {
                ...
                // cin.ignore();
                // cin.getline(emp[i].direccion, 20, '\n');
                aleatorio(emp[i].direccion, CALLES);
